...
class FriendViewModel: ObservableObject {
    ...
    private func loadDummyData() {
        friends = [
            User(id: "ROAM-4F2K", username: "Maya Chen", points: 1200, currentStreak: 5, friendList: [], pendingFriendRequests: [], unlockedCustomizations: []),
            User(id: "DASH-9X1P", username: "Diego Mar", points: 800, currentStreak: 3, friendList: [], pendingFriendRequests: [], unlockedCustomizations: [])
        ]
        
        pendingRequests = [
            User(id: "WALK-7B3M", username: "Noor R.", points: 450, currentStreak: 1, friendList: [], pendingFriendRequests: [], unlockedCustomizations: [])
        ]
    }
}
